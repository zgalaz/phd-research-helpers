function [e_train, e_valid] = learning_curve_or(X, X_val, y, y_val, ...
    fun_sett, ml_sett)

% [e_train, e_valid] = learning_curve_or(X, X_val, y, y_val, ...
%    fun_sett, ml_sett)
% 
% This function trains/validates the ordinal regression algorithm using 
...
% fun_sett.algorithm - classification algorithm (predefines: or)
...
if (fun_sett.plot)
    ...
    for i = 1:length(fun_sett.metrics)
        ...
        title(['OR: learning curves (' fun_sett.metrics{i} ')']);
