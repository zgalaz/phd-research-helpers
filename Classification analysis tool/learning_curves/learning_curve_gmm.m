function [e_train, e_valid] = learning_curve_gmm(X, X_val, y, y_val, ...
    fun_sett, ml_sett)

% [e_train, e_valid] = learning_curve_gmm(X, X_val, y, y_val, ...
%    fun_sett, ml_sett)
% 
% This function trains/validates the gaussian mixture model classification 
...
% fun_sett.algorithm - classification algorithm (predefined: gmm)
...
% ml_sett.mixt = number of Gaussian mixtures 
% 
% 
% 
% --
...
if (fun_sett.plot)
    ...
    for i = 1:length(fun_sett.metrics)
        ...
        title(['GMM: learning curves (' fun_sett.metrics{i} ')']);
